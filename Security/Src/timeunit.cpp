...
TimeManager::TimeManager(uint8_t seconds, uint8_t minutes, uint8_t hours, uint8_t week_day, uint8_t date_day, uint8_t month, int year, bool use_military_time) {
	...
	passage_of_time_.year_.time_value = year % 100;
	passage_of_time_.year_.max_time = 99;
}


void TimeManager::setTime(uint8_t seconds, uint8_t minutes, uint8_t hours, uint8_t week_day, uint8_t date_day, uint8_t month, int year) {
	passage_of_time_.seconds_.time_value = seconds;
	passage_of_time_.minutes_.time_value = minutes;
	passage_of_time_.hours_.time_value = hours;
	passage_of_time_.week_day_.time_value = week_day;
