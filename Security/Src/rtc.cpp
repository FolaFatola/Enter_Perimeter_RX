...
RTC_Status_E Time_RTC::rtc_get_seconds(uint8_t &num_seconds) {
	RTC_Status_E status = RTC_OK;
	...
	TimeSpan time_span = tim_manager_.getTimeSpan();
	num_seconds = time_span.seconds_.time_value;

	return status;
}


RTC_Status_E Time_RTC::rtc_get_minutes(uint8_t &num_minutes) {
	RTC_Status_E status = RTC_OK;
	...
	TimeSpan time_span =  tim_manager_.getTimeSpan();
	num_minutes = time_span.minutes_.time_value;

	return status;
}

RTC_Status_E Time_RTC::rtc_get_hours(uint8_t &num_hours) {
	RTC_Status_E status = RTC_OK;
	...
	TimeSpan time_span =  tim_manager_.getTimeSpan();
	num_hours = time_span.hours_.time_value;

	return status;
}
//
RTC_Status_E Time_RTC::rtc_get_date_day(uint8_t &date_day) {
	RTC_Status_E status = RTC_OK;
	...
	TimeSpan time_span =  tim_manager_.getTimeSpan();
	date_day = time_span.date_day_.time_value;

	return status;
}

RTC_Status_E Time_RTC::rtc_get_week_day(uint8_t &week_day) {
	RTC_Status_E status = RTC_OK;
	...
	TimeSpan time_span =  tim_manager_.getTimeSpan();
	week_day = time_span.week_day_.time_value;

	return status;
}

RTC_Status_E Time_RTC::rtc_get_month(uint8_t &month) {
	RTC_Status_E status = RTC_OK;
	...
	TimeSpan time_span =  tim_manager_.getTimeSpan();
	month = time_span.month_.time_value;

	return status;
}

RTC_Status_E Time_RTC::rtc_get_year(int &year) {
	RTC_Status_E status = RTC_OK;
	...
	TimeSpan time_span =  tim_manager_.getTimeSpan();
	year = millennium + time_span.year_.time_value;
